<script>
    export default {
        ...
        computed: {
            selectedMilling() {
                return this.$store.getters['getMillingById'];
            }
        },
        mounted() {
        }
...
<template>
    <picture class="f-preview">
        <template v-if="selectedMilling && selectedMilling.img">
            <img :src="selectedMilling.img" :alt="selectedMilling.title">
        </template>
        <svg viewBox="0 0 490.667 490.667" class="f-preview__no-photo" v-else>
